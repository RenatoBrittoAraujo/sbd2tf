...
# previne prints do sqlalchemy. o motivo é porque os prints
# gastam muito tempo de processamento e não são necessários
# diminuem significativamente o tempo para se inserir todos
# os dados dentro da base de dados mysql
